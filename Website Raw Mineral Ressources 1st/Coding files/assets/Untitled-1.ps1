...
<html lang="en">
  <head>
    ...
    <title>Details — MyBusiness</title>
    <link rel="stylesheet" href="/styles.css" />
  </head>
  <body>
    <header id="site-header" class="visible">
      <div class="container">
        <a class="logo" href="/index.html">MyBusiness</a>
        <nav id="main-nav">
...
# MyBusiness — Simple Showcase

This is a minimal, responsive static site to showcase your business and build reputation. It uses a full-screen hero image on the homepage and two extra pages for details.
